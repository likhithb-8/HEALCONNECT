        ...
        <div className="flex h-full">
          ...
          >
            <ul className="w-full flex flex-col mx-auto px-2 py-2">
              ...
              <li key={"Setting"}>
                <Link href="/admin/setting" aria-label="Settings">
                  <div
                    className={`sidebar-icon group ${
              ...
              <li key={"Doctors"}>
                <Link href="/admin/doctors" aria-label="Doctors">
                  <div
                    className={`sidebar-icon group ${
                  ...
                  >
                    <FaUsers size={28} />
                    <span className="sidebar-tooltip group-hover:scale-100">Doctors</span>
                  </div>
                </Link>
              </li>
            </ul>
