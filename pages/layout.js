...
export default function Layout({ children }) {
  ...
  useEffect(() => {
    ...
    const publicPages = ["/", "/login", "/signup", "/signup-test", "/faq", "/contact", "/about", "/privacy", "/terms", "/how-it-works", "/open-source", "/support", "/appointments", "/monitoring", "/prescriptions", "/health-tips", "/profile"];
