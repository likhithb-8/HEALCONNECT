...
// Move utility functions outside component to prevent re-definition on every render
...
export default function Monitoring() {
  ...
  // Derive critical alert directly from state using useMemo
  // This avoids the extra render cycle caused by useEffect + useState
  ...
  // Memoize current vitals to stabilize reference passed to child components
  const currentVitals = useMemo(() => ({
    heartRate: data.heartRate ? parseFloat(data.heartRate) : (isMonitoring ? currentHeartRate : 72),
    oxygen: data.oxygen ? parseFloat(data.oxygen) : (isMonitoring ? currentOxygen : 98),
