...
// Move static utility functions outside component to prevent re-creation on every render
...
export default function Monitoring() {
  ...
  // Derive critical alert status from vitals via useMemo to avoid redundant render cycle
  ...
  // Memoize current vitals to prevent downstream re-renders of HealthInsights
