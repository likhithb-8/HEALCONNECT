...
// Static utility functions moved outside component to prevent re-definition on every render
...
export default function Monitoring() {
  ...
  // Derived alert state using useMemo to eliminate redundant re-render cycle from useEffect
  ...
  // Stabilize currentVitals object to prevent unnecessary re-renders of memoized child components
