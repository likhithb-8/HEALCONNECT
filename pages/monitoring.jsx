...
// Utility functions moved outside to prevent re-definition on every render
...
export default function Monitoring() {
  ...
  // Derived state for alerts - replaces useState + useEffect anti-pattern
  ...
  // Memoize vitals object to maintain reference equality for child components
  ...
  }), [data, isMonitoring, currentHeartRate, currentOxygen]);
