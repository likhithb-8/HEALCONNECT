...
// Utility functions moved outside component to prevent re-definition on every render
...
export default function Monitoring() {
  ...
  // Derive critical alert status directly from vitals to eliminate redundant render cycle
  ...
  // Memoize current vitals object to stabilize reference for child components
