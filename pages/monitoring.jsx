...
export default function Monitoring() {
  ...
  // Memoized current vitals to prevent unstable object references in child components
  ...
  // Derive critical alert status directly from vitals to eliminate redundant render cycles
