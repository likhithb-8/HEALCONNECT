...
// Move static helpers outside the component to prevent re-definition on every render
...
export default function Monitoring() {
  ...
  // Eliminate double render by deriving alert status during the main render cycle
  ...
  // Stabilize the vitals object to prevent unnecessary child re-renders
              ...
              {history.length > 0 ? (
                <div className={styles.historyList}>
                  {history.map((record, index) => (
                    <motion.div
                      key={record.date} // Use stable key for efficient reconciliation
